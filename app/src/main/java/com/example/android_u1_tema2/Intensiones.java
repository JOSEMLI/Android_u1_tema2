...
public class Intensiones  extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_intensiones);
    }
        ...
        builder.setNeutralButton("Google Map", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (mapIntent.resolveActivity(getPackageManager()) != null)
                    ...
                    Toast.makeText(Intensiones.this, "Maps no esta instalado", Toast.LENGTH_LONG).show();
            }
        });
        builder.setNegativeButton("Waze", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (mapIntent.resolveActivity(getPackageManager()) != null)
                    ...
                    Toast.makeText(Intensiones.this, "Waze no esta instalado", Toast.LENGTH_LONG).show();
            }
        });
